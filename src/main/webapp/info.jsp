							...
							<tr>
								<td>
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" id="inputName" name="name" placeholder="Email" value="${sessionScope.email}">
										</div>
									</div>
									<div class="control-group">
										<label class="control-label" for="inputAddress">Address</label>
										<div class="controls">
											<input type="text" id="inputAddress" name="address" placeholder="Address">
										</div>
									</div>
									<div class="control-group">
										<label class="control-label" for="inputDiscount">Discount
											Code</label>
										<div class="controls">
											<input type="text" id="inputDiscount" name="discount" placeholder="Code">
										</div>
									</div>
								</td>
							</tr>
